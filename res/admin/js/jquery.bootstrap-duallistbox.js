;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      filterTextClear: 'Mostre todos',
      filterPlaceHolder: 'Filtrar',
      moveSelectedLabel: 'Mova os selecionados',
      moveAllLabel: 'Mova todos',
      removeSelectedLabel: 'Remova os selecionados',
      removeAllLabel: 'Remova todos',
      ...
      infoText: 'Motrando {0} Ingredientes',                                                        // text when all options are visible / false for no info text
      infoTextFiltered: '<span class="label label-warning">Mostrando</span> de {0} até {1}', // when not all of the options are visible due to the filter
      infoTextEmpty: 'Lista de Ingredientes vazia.',                                                        // when there are no options present in the list
